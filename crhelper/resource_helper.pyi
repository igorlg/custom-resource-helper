...
class CfnResource:
    ...
    Data: Any = ...
    NoEcho: bool = ...
    LastResponse: Optional[Dict[str, Any]] = ...
    def __init__(self, json_logging: bool = ..., log_level: str = ..., boto_level: str = ..., polling_interval: int = ..., sleep_on_delete: int = ..., ssl_verify: Optional[bool] = ..., test_mode: bool = ...) -> None: ...
